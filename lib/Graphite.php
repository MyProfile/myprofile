...
class Graphite
{
	public function __construct( $namespaces = array(), $uri = null )
	{
		...
		$this->ns( "wot",   "http://xmlns.com/wot/0.1/" );
        $this->ns( "rsa",  "http://www.w3.org/ns/auth/rsa#" );
        $this->ns( "cert",  "http://www.w3.org/ns/auth/cert#" );
...
class Graphite_Node
{
	...
	function dump() { return "<div style='padding:0.5em; background-color:white;border:dashed 1px grey;'>Non-existant Node</div>"; }
...
class Graphite_Resource extends Graphite_Node
{
	...
	public function dump( $options = array() )
	{
		...
		$r.= "\n<a name='".htmlentities($this->uri)."'></a><div style='text-align:left;font-family: arial;padding:0.5em; background-color:white;border:dashed 1px grey;margin-bottom:2px;'>\n";
